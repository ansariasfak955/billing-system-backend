...
class TableHelper
{
    public static function createTables($company_id)
    {
        ...
        /* Creating dynamic sales _technical_incidents table */
        ...
        if (!Schema::hasTable('company_'.$company_id.'_technical_tables')) {
            Schema::create('company_'.$company_id.'_technical_tables', function (Blueprint $table) {
                $table->id();
                $table->string('reference')->nullable();
                $table->string('reference_number')->nullable();
                $table->string('date')->nullable();
        ...
        /* Creating dynamic technical attachment  table */
