...
Route::group(['namespace' => 'Api'], function() {
    ...
    Route::get('{company_id}/preview-template', 'SendEmailController@sendEmail');
    ...
    Route::group(['middleware' => ['auth:api']], function(){
        ...
        Route::group(["prefix" => "{company_id}/"], function(){
            ...
            Route::prefix('reports')->group(function () {
                ...
                Route::get('of-profit', 'ReportController@ofProfit');
                Route::get('invoicing-by-client', 'ReportController@InvoicingByClient');
            ...
            // Report Export
            Route::post('client-sales-export', 'ReportExportController@clientSalesExport');
            Route::post('agents-sales-export', 'ReportExportController@salesAgentsExport');
            Route::post('items-sales-export', 'ReportExportController@itemsSalesExport');
